...
type ConfigServiceClient interface {
	// GetSystemConfig returns the configuration for the requested system as a JSON string
	GetSystemConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (*GetConfigResponse, error)
}
...
func (c *configServiceClient) GetSystemConfig(ctx context.Context, in *GetConfigRequest, opts ...grpc.CallOption) (*GetConfigResponse, error) {
...
type ConfigServiceServer interface {
	// GetSystemConfig returns the configuration for the requested system as a JSON string
	GetSystemConfig(context.Context, *GetConfigRequest) (*GetConfigResponse, error)
...
func (UnimplementedConfigServiceServer) GetSystemConfig(context.Context, *GetConfigRequest) (*GetConfigResponse, error) {
...
func _ConfigService_GetSystemConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigServiceServer).GetSystemConfig(ctx, req.(*GetConfigRequest))
	}
